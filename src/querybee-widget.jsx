                      ...
                      <div className="flex flex-col gap-1">
                        {quick.map((q, index) => (
                          <motion.div
                            ...
                            className="relative overflow-hidden rounded-[12px] border border-[hsl(var(--qb-border)/0.3)] bg-gradient-to-r from-[hsl(var(--qb-card)/0.6)] to-[hsl(var(--qb-card)/0.3)] backdrop-blur-sm hover:from-[hsl(var(--qb-card)/0.8)] hover:to-[hsl(var(--qb-card)/0.5)] transition-all duration-300 group"
                          >
                            ...
                            <div className="relative flex items-center justify-between gap-2 p-2">
                              <button
                                className="flex-1 text-left text-[length:calc(var(--qb-font-size)-1px)] text-[hsl(var(--qb-fg))] font-medium hover:text-[hsl(var(--qb-accent))] transition-all duration-300 group-hover:translate-x-1"
                                onClick={() => sendMessage(q.text)}
                              >
                                <span className="flex items-center gap-1">
                                  <span className="text-sm">{q.text.split(' ')[0]}</span>
                                  <span className="text-[length:calc(var(--qb-font-size)-2px)] opacity-80">
                                    {q.text.split(' ').slice(1).join(' ')}
                                  </span>
                                </span>
                              </button>
                              <button
                                className="grid h-6 w-6 place-items-center rounded-[10px] border border-[hsl(var(--qb-border)/0.5)] text-[hsl(var(--qb-muted-fg))] hover:bg-[hsl(var(--qb-accent))] hover:text-[hsl(var(--qb-accent-fg))] hover:border-[hsl(var(--qb-accent))] transition-all duration-300 group-hover:scale-110"
                      ...
                      >
                        <span
                          className={cn(
                            ...
                            (theme.mode || 'dark') === 'dark' ? 'translate-x-[1.25rem]' : 'translate-x-0'
                          )}
                        />
                      </button>
                      <span className={cn(
